  ...
  return (
    <section id="clients" className="py-16 sm:py-24 md:py-32 w-full bg-primary overflow-hidden relative select-none">
      ...
      <div className="container mx-auto px-4 sm:px-6 mb-10 sm:mb-16 text-center relative z-10">
        <ScrollReveal>
          <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-black text-black tracking-tight">
          ...
          >
            {[...items, ...items, ...items, ...items].map((item, i) => (
              <motion.span
                ...
                className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-black uppercase text-black/60 hover:text-black transition-all duration-300 cursor-pointer inline-block"
              >
                {item}
              </motion.span>
            ))}
          ...
          >
            {[...items, ...items, ...items, ...items].map((item, i) => (
              <motion.span
                ...
                style={{
                  WebkitTextStroke: "1.8px rgba(0,0,0,0.8)",
                  color: "transparent",
                }}
              >
                {item}
