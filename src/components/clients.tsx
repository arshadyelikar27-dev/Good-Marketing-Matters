...
export function Clients() {
  return (
    <section id="clients" className="py-24 md:py-32 w-full bg-surface overflow-hidden relative select-none border-y border-black/10">
        ...
        <div className="flex w-full group">
          ...
          >
            {[...items, ...items, ...items, ...items].map((item, i) => (
              <span
                key={i}
                className="text-6xl sm:text-8xl md:text-9xl font-black uppercase tracking-tighter cursor-default transition-all duration-500 group-hover:blur-sm hover:!blur-none hover:!text-primary hover:drop-shadow-[0_0_30px_rgba(104,17,201,0.5)] hover:scale-110 hover:!stroke-none"
                style={{
