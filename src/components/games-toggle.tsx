...
const MINI_GAMES = [
  {
    ...
    icon: Brain,
    badge: "Puzzle",
    color: "from-[#6811C9] to-[#6811C9]",
    bgAccent: "bg-[#6811C9]/10 text-[#6811C9]",
  },
  {
    id: "tictactoe",
  ...
  },
  {
    ...
    badge: "Battle",
    color: "from-[#6811C9] to-[#6811C9]",
    bgAccent: "bg-[#6811C9]/15 text-[#6811C9]",
  },
  {
    id: "reflex",
        ...
        {isOpen && (
          <div className="fixed inset-0 z-[9990] flex items-center justify-center p-3 sm:p-6 pointer-events-auto">
            ...
            >
              ...
              {/* Bottom Footer Note */}
              <div className="mt-6 pt-4 border-t border-white/10 flex items-center justify-between text-xs text-white">
