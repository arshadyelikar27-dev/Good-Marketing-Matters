...
export function Footer() {
  ...
  return (
    <footer className="relative w-full bg-dark-section text-white overflow-hidden pt-32 pb-10 border-t border-white/10">

      {/* Background Glow */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[80vw] h-[50vh] bg-accent/10 rounded-t-full blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-[1400px] mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 mb-24">
          ...
          <div className="lg:col-span-5 flex flex-col">
            ...
            <TextReveal 
              ...
              className="text-white text-lg sm:text-xl font-medium max-w-md leading-relaxed flex flex-wrap"
              delay={0.2}
            />

            <ScrollReveal delay={0.4} className="mt-12 flex gap-4">
              <Link href="#" className="w-12 h-12 rounded-full border border-accent/30 flex items-center justify-center text-accent hover:bg-accent hover:text-black transition-all duration-300 hover:shadow-[0_0_20px_rgba(224,243,71,0.5)]">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-12 lg:gap-8">
            <ScrollReveal delay={0.3} className="flex flex-col gap-6">
              <h4 className="text-xl font-bold uppercase tracking-widest text-accent mb-4 drop-shadow-[0_0_10px_rgba(224,243,71,0.3)]">Explore</h4>
            ...
            <ScrollReveal delay={0.4} className="flex flex-col gap-6">
              <h4 className="text-xl font-bold uppercase tracking-widest text-accent mb-4 drop-shadow-[0_0_10px_rgba(224,243,71,0.3)]">Contact</h4>
        ...
        <ScrollReveal delay={0.5}>
          <div className="w-full py-10 md:py-16 border-y border-white/20 relative group overflow-hidden rounded-[2rem] bg-black/40 backdrop-blur-sm mb-16">
            <div className="absolute inset-0 bg-gradient-to-r from-accent/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none" />
            <button onClick={openContactModal} className="flex flex-col md:flex-row items-center justify-between w-full text-center md:text-left gap-6 md:gap-8 px-6 md:px-16 relative z-10 cursor-pointer">
              <motion.h2 
                ...
                className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tight text-white uppercase group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-accent transition-all duration-500 flex flex-wrap justify-center md:justify-start"
              >
              ...
              <motion.div 
                ...
                className="w-20 h-20 md:w-32 md:h-32 rounded-full bg-accent flex items-center justify-center group-hover:scale-110 transition-all duration-500 shadow-[0_0_30px_rgba(224,243,71,0.6)] group-hover:shadow-[0_0_50px_rgba(224,243,71,0.8)] shrink-0"
              >
        ...
        <ScrollReveal delay={0.6}>
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-8 border-t border-white/20 text-white font-medium">
