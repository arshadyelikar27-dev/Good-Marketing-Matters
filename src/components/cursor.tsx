...
export function CustomCursor() {
  ...
  return (
    <div className="pointer-events-none hidden md:block">
      {/* INNER DOT */}
      <motion.div
        className="fixed top-0 left-0 w-2.5 h-2.5 bg-primary rounded-full pointer-events-none z-[999999] mix-blend-difference origin-center"
        style={{
          x: springX,
          y: springY,
          translateX: "-50%",
      ...
      <motion.div
        ...
        animate={{
          ...
          backgroundColor: cursorState === "hover" ? "rgba(255, 255, 255, 0.95)" : "rgba(255, 255, 255, 0)",
          scale: cursorState === "hidden" ? 0 : cursorState === "hover" ? 1.5 : 1,
          borderColor: cursorState === "hover" ? "rgba(255, 255, 255, 0.8)" : "rgba(255, 255, 255, 0.8)",
