  ...
  return (
    <div className="fixed bottom-4 left-4 sm:bottom-6 sm:left-6 z-50 pointer-events-auto">
      ...
      <motion.a
        ...
        className="relative group flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#25D366] text-white shadow-[0_10px_25px_rgba(37,211,102,0.3)] hover:shadow-[0_15px_35px_rgba(37,211,102,0.5)] transition-all duration-300 border border-[#25D366]/20"
      >
        {/* Pulsing Outer Ring */}
        ...
        {/* Hover Tooltip Label */}
        <span className="absolute left-16 px-3 py-1.5 rounded-xl bg-white/95 text-heading font-bold text-xs whitespace-nowrap border border-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none shadow-lg font-heading">
          Chat on WhatsApp
        </span>
      </motion.a>
    </div>
