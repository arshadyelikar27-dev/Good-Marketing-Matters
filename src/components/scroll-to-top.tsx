    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 w-12 h-12 sm:w-13 sm:h-13 rounded-full bg-primary text-primary-foreground flex items-center justify-center shadow-[0_8px_25px_rgba(104, 17, 201,0.45)] hover:shadow-[0_12px_35px_rgba(104, 17, 201,0.7)] border border-primary/30 transition-shadow duration-300"
        >
